  ...
  return (
    <div className="space-y-12 sm:space-y-20">
      ...
      <section className="text-center py-12 sm:py-24">
        ...
        <p className="mt-3 sm:mt-4 text-base sm:text-xl text-medium-grey max-w-xl mx-auto">
          Stories worth your time
        </p>
        <Link
          to={`/episodes/${latestEpisode.slug}`}
          className="inline-block mt-6 sm:mt-8 px-8 py-3 min-h-[44px] bg-orange text-white font-semibold rounded-lg hover:opacity-90 transition-opacity"
        >
          Listen Now
        </Link>
      </section>
